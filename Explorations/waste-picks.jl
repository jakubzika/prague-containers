...
# ╔═╡ 655627af-6ec9-441e-9394-0fd43fd64680
using HTTP, CSV, JSON, Dates, PlutoUI

# ╔═╡ d9eb6385-e61e-4680-a8da-de2b358d8bb7
include("src/golemioAPI.jl")

# ╔═╡ 37a195ac-9b29-11ec-11dd-a3d4146135a0
md"""# Waste picks"""

# ╔═╡ f15203fd-39b0-4e42-b376-f6411f296257
...
# ╔═╡ 526cc51b-f4af-4e08-a638-5763dd81a2cb
response = GolemioAPI.getRequest(
	config, 
	"/sortedwastestations/picks/", 
	Dict(
		"containerId" => "d95f690b-f66d-5c29-8455-12baa5cf1ac7"
	)
)
