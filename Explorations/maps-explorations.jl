...
# ╔═╡ d28ea98b-d8e5-40b6-89a0-25855ea4f1b0
using CSV,DataFrames, Dates, PlutoUI, TimeZones, OpenStreetMapXPlot, OpenStreetMapX

# ╔═╡ 5166c4b4-9d84-11ec-04b1-3d69e866bf93
begin
	include("src/data-conversion.jl")
end

# ╔═╡ c8e688be-251c-409f-af76-13f111f64b26
containers = DataConversion.loadMeasuredContainers()

# ╔═╡ 004278f8-71e6-464a-b994-dc386fb58a25


# ╔═╡ 0f175de8-6e92-4f45-b7a7-182c0fc11876
# scatter(containers.lng, containers.lat, marker=:point, mc="#0072BD", show=true)

# ╔═╡ 9b108636-d2c9-4cfc-a73e-8dc6348f464e
# begin
# 	ortho = project(start_pt=[10 30], end_pt=[50 60], step=10, km=true);
# 	coast(region=[0 60 20 70], proj=:equidistCylindrical, frame=:g, res=:crude, land=:black, B=:a)
# 	plot!(ortho, lw=3, lc=:green, name="ortho_line.png", show=true)
# end

# ╔═╡ 5fcc5926-9e4a-4d38-979c-e360a24da47b
